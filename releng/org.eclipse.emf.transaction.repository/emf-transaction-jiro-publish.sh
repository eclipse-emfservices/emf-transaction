...
export PROJECT_NAME="EMF Transaction"
export PROJECT_PREFIX="org.eclipse.emf.transaction"
...
localTarget=${WORKSPACE}/releng/org.eclipse.emf.transaction.repository/target
...
create_composite "EMF Transaction" . $entries
