...
public class TransactionOptionsTest extends AbstractTest {
	...
	/**
	 * Tests that the <code>OPTION_NO_UNDO</code> results in the write action not
	...
	/**
	 * Tests that the <code>OPTION_NO_UNDO</code> does not have any effect on the
	 * undoability of regular EMF commands.
	 */
	@Test
	...
	/**
	 * Tests that notifications from nested unvalidated transactions are included in
	 * the post-commit event (i.e., unvalidated does not imply silent).
	 */
	@Test
	...
	/**
	 * Tests that nested unvalidated transactions are not validated, but their outer
	 * transactions are.
	 */
	@Test
	...
	/**
	 * Tests that a root-level transaction's notifications are not retained after it
	 * commits. This is important because the transaction in question may linger for
	 * some time in a command stack or operation history.
	 */
	@Test
	...
	/**
	 * Tests that a silent unprotected transaction never accumulates notifications,
	...
	/**
	 * Tests that when a silent unprotected transaction has children that think they
	 * are collecting notifications, they do not, but notifications for ancestor
