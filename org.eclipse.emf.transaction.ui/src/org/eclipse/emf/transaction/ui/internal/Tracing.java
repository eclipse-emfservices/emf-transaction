 ...
 * </copyright>
 *
 * $Id: Tracing.java,v 1.1 2006/01/03 20:44:14 cdamus Exp $
 */
...
public class Tracing {
	...
	protected static boolean shouldTrace() {
		Plugin plugin = EMFTransactionUIPlugin.getPlugin();
	...
	public static void catching(
		...
		if (shouldTrace(EMFTransactionUIDebugOptions.EXCEPTIONS_CATCHING)) {
	...
	public static void throwing(
		...
		if (shouldTrace(EMFTransactionUIDebugOptions.EXCEPTIONS_THROWING)) {
