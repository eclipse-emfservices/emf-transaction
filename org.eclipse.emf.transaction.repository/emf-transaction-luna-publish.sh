...
if [ "$dropFiles" = y ]; then
	...
	qualifiedVersion=$(find drops/eclipse/features/ -maxdepth 1 | grep "org.eclipse.emf.transaction_")
	...
	# emf transaction SDK
	zip -r $dropDir/emf-transaction-SDK-$version.zip \
	...
	md5sum $dropDir/emf-transaction-SDK-$version.zip > $dropDir/emf-transaction-SDK-$version.zip.md5
	echo "Created emf-transaction-SDK-$version.zip"
				
	# emf-transaction runtime
	zip -r $dropDir/emf-transaction-runtime-$version.zip \
		eclipse/epl-v10.html eclipse/notice.html \
		eclipse/features/org.eclipse.emf.transaction_* \
		eclipse/features/org.eclipse.emf.workspace_* \
		eclipse/plugins/org.eclipse.emf.transaction_* \
		...
		eclipse/plugins/org.eclipse.emf.workspace_* \
		eclipse/plugins/org.eclipse.emf.workspace.ui_*
	md5sum $dropDir/emf-transaction-runtime-$version.zip > $dropDir/emf-transaction-runtime-$version.zip.md5
	echo "Created emf-transaction-runtime-$version.zip"
				
	# emf-transaction examples
	zip -r $dropDir/emf-transaction-examples-$version.zip \
		eclipse/epl-v10.html eclipse/notice.html \
	...
	md5sum $dropDir/emf-transaction-examples-$version.zip > $dropDir/emf-transaction-examples-$version.zip.md5
	echo "Created emf-transaction-examples-$version.zip"
				
	# emf-transaction automated-tests
	zip -r $dropDir/emf-transaction-automated-tests-$version.zip \
		eclipse/epl-v10.html eclipse/notice.html \
	...
	md5sum $dropDir/emf-transaction-automated-tests-$version.zip > $dropDir/emf-transaction-automated-tests-$version.zip.md5
	echo "Created emf-transaction-automated-tests-$version.zip"
	...
	echo "Created emf-transaction-Update-Site-$version.zip"
	cd ..
	...
	remoteDropDir=/home/data/httpd/download.eclipse.org/modeling/emf/transaction/downloads/drops/$dropDir
