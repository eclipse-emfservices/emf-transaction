...
localTarget=${WORKSPACE}/org.eclipse.emf.transaction.repository/target
...
remoteUpdateSiteBase="modeling/emf/transaction/updates/$remoteSite"
...
qualifiedVersion=$(find $localUpdateSite/features/ -maxdepth 1 | grep "org.eclipse.emf.transaction_" | sed 's/.jar$//')
...
zip -r ../$localDropDir/emf-transaction-SDK-$version.zip \
	...
	eclipse/features/org.eclipse.emf.transaction.source_* \
	eclipse/features/org.eclipse.emf.workspace_* \
	eclipse/features/org.eclipse.emf.workspace.source_* \
	eclipse/plugins/org.eclipse.emf.transaction_* \
	eclipse/plugins/org.eclipse.emf.transaction.doc_* \
	eclipse/plugins/org.eclipse.emf.transaction.ui_* \
	eclipse/plugins/org.eclipse.emf.transaction.ui.source_* \
	eclipse/plugins/org.eclipse.emf.transaction.source_* \
	eclipse/plugins/org.eclipse.emf.workspace_* \
	eclipse/plugins/org.eclipse.emf.workspace.ui_* \
	eclipse/plugins/org.eclipse.emf.workspace.ui.source_* \
	eclipse/plugins/org.eclipse.emf.workspace.source_*
md5sum ../$localDropDir/emf-transaction-SDK-$version.zip > ../$localDropDir/emf-transaction-SDK-$version.zip.md5
echo "`date +%Y-%m-%d-%H:%M:%S` Created emf-transaction-SDK-$version.zip"
...
zip -r ../$localDropDir/emf-transaction-runtime-$version.zip \
	...
	eclipse/plugins/org.eclipse.emf.workspace_* \
	eclipse/plugins/org.eclipse.emf.workspace.ui_*
md5sum ../$localDropDir/emf-transaction-runtime-$version.zip > ../$localDropDir/emf-transaction-runtime-$version.zip.md5
echo "`date +%Y-%m-%d-%H:%M:%S` Created emf-transaction-runtime-$version.zip"
...
zip -r ../$localDropDir/emf-transaction-examples-$version.zip \
	...
	eclipse/features/org.eclipse.emf.workspace.examples.source_* \
	eclipse/plugins/org.eclipse.emf.transaction.examples_* \
	eclipse/plugins/org.eclipse.emf.transaction.examples.source_* \
	eclipse/plugins/org.eclipse.emf.workspace.examples_* \
	eclipse/plugins/org.eclipse.emf.workspace.examples.source_* \
	eclipse/plugins/org.eclipse.emf.workspace.examples.library.editor_* \
	eclipse/plugins/org.eclipse.emf.workspace.examples.library.editor.source_*
md5sum ../$localDropDir/emf-transaction-examples-$version.zip > ../$localDropDir/emf-transaction-examples-$version.zip.md5
echo "`date +%Y-%m-%d-%H:%M:%S` Created emf-transaction-examples-$version.zip"
...
md5sum ../$localDropDir/emf-transaction-automated-tests-$version.zip > ../$localDropDir/emf-transaction-automated-tests-$version.zip.md5
echo "`date +%Y-%m-%d-%H:%M:%S` Created emf-transaction-automated-tests-$version.zip"
	
cd $tmpDir
		
cd $stagedUpdateSite
zip -r ../../../$localDropDir/emf-transaction-Update-$version.zip features plugins binary artifacts.jar content.jar
md5sum ../../../$localDropDir/emf-transaction-Update-$version.zip > ../../../$localDropDir/emf-transaction-Update-$version.zip.md5
echo "`date +%Y-%m-%d-%H:%M:%S` Created emf-transaction-Update-Site-$version.zip"
...
remoteDropDir=/home/data/httpd/download.eclipse.org/modeling/emf/transaction/downloads/$localDropDir
